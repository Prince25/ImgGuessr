...
const sstk = require("shutterstock-api");    // https://www.npmjs.com/package/shutterstock-api
const print = require("./printToConsole.js");
const askQuestion = require("./askQuestion.js");
const { compareTwoStrings } = require("string-similarity");
const { initializeSaveFile, loadSaveFile, saveFile } = require('./saveFileHandler.js');
...
async function getImage(category) {
    const image = await fetchImages(category);
    return image;
}


// Play game via console
async function playRound(category) {
    const image = await fetchImages(category);
...
module.exports = { playRound, getImage };